...
public class ArrayIndexedCollection implements List {
	...
	/**
	 * Class which gets the element from the collection.
	 * @author Tin Jukić
	 *
	 */
	private static class ElementsGetterClass implements ElementsGetter {
		...
		private ArrayIndexedCollection reference;
		 ...
		 * @param reference
		 */
		private ElementsGetterClass(int collectionSize, Object[] collectionElements, double savedModificationCount, ArrayIndexedCollection reference) {
		...
		public Object getNextElement() throws NoSuchElementException, ConcurrentModificationException {
			...
			Object element = this.collectionElements[this.index];
			this.index++;
